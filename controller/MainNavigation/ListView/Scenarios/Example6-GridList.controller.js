sap.ui.define([
    ...
    var Controller = Controller.extend("DemoUXapp.controller.MainNavigation.ListView.Scenarios.Example6-GridList", {
        onInit: function () {
            var sURL = "/";
        ...
        onPress: function (oEvent) {
            ...
            this.getRouter().navTo("sap.uxap.ObjectPageSubSection/sap.f.GridList/sap.f.GridListItem", {
                scenarioId: oAttr
            });
        },
        getRouter: function () {
