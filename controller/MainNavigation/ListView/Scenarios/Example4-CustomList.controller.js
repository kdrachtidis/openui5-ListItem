sap.ui.define([
    ...
    var Controller = Controller.extend("DemoUXapp.controller.MainNavigation.ListView.Scenarios.Example4-CustomList", {
        onInit: function () {
            var sURL = "/";
        ...
        onPress: function (oEvent) {
            ...
            this.getRouter().navTo("sap.uxap.ObjectPageSubSection/sap.m.List/sap.m.CustomListItem", {
                scenarioId: oAttr
            });
        },
        getRouter: function () {
