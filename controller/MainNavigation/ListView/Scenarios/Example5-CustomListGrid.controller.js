sap.ui.define([
    ...
    var Controller = Controller.extend("DemoUXapp.controller.MainNavigation.ListView.Scenarios.Example5-CustomListGrid", {
        onInit: function () {
            var sURL = "/";
        ...
        onPress: function (oEvent) {
            ...
            this.getRouter().navTo("sap.uxap.ObjectPageSubSection/sap.f.GridList/sap.m.CustomListItem", {
                scenarioId: oAttr
            });
        },
        getRouter: function () {
