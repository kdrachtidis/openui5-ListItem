sap.ui.define([
    ...
    var Controller = Controller.extend("DemoUXapp.controller.MainNavigation.ListView.Scenarios.Example1-StandardList", {
        onInit: function () {
            var sURL = "/";
        ...
        onPress: function (oEvent) {
            ...
            this.getRouter().navTo("sap.uxap.ObjectPageSubSection/sap.m.List/sap.m.StandardListItem", {
                scenarioId: oAttr
            });
        },
        getRouter: function () {
