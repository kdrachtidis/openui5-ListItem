sap.ui.define([
    ...
    var Controller = Controller.extend("DemoUXapp.controller.MainNavigation.ListView.Scenarios.Example2-ObjectList", {
        onInit: function () {
            var sURL = "/";
        ...
        onPress: function (oEvent) {
            ...
            this.getRouter().navTo("sap.uxap.ObjectPageSubSection/sap.m.List/sap.m.ObjectListItem", {
                scenarioId: oAttr
            });
        },
        getRouter: function () {
